...
CREATE TABLE Business_Data_Employee
(
...
(
IteamId INT NOT NULL PRIMARY KEY IDENTITY(1,1), 
...
(
SrNo INT NOT NULL PRIMARY KEY IDENTITY(1,1),
EmpNo INT,
ItemNo INT,
 FOREIGN KEY (EmpNo) REFERENCES Business_Data_Employee(EmployeeId),
 FOREIGN KEY (ItemNo) REFERENCES car_inventory(IteamId)
)



SELECT * FROM Business_Data_Employee
SELECT * FROM car_inventory
SELECT * FROM car_sales


INSERT INTO Business_Data_Employee 
